...
const SAMPLE: HistoryItem[] = [
  {
    id: "1",
    timestamp: "2025-09-17T11:23:00.000Z",
    titleBold: "Task 124-012",
    description: "assigned to Engr Tope Martins",
  },
  {
    id: "2",
    timestamp: "2025-09-17T11:23:00.000Z",
    titleBold: "Task 124-012",
    description: "resolved by Engr Tope Martins",
  },
  {
    id: "3",
    timestamp: "2025-09-17T11:23:00.000Z",
          ...
          {history.map((it: any, idx: number) => {
            ...
            return (
              <XStack key={it.id} gap="$3">
                ...
                {/* Content */}
                <YStack flex={1} gap="$1">
                  <Text fos={12} color="$gray11">
                    {formatTimeDate(it.updatedAt)}
                  </Text>
                  <Text fos={14} color="$gray12">
                    <Text fos={14} fow="700" color="$gray12" tt="capitalize">
                      {it.taskTitle}
                    </Text>{" "}
                    {it.issueDescription}
                  </Text>
